...
is a continuation of the clause-selection algorithm [2]. Further functionality
was developed during [3].
...
lets me force static compilation for `zlib`. If you don't care about static compilation,
